...
# System deps: build tools for wheels that need compiling on ARM,
# tzdata for Europe/Madrid, curl for healthchecks.
...
RUN mkdir -p /app/strategies /app/logs /app/alerts \
